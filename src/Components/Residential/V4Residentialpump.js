...
const V4Residentialpump = () => {
    return (
        <div>
            ...
            <h2 className=" p-2 text-6xl font-bold my-20 ">Rust free V4- Stainless Steel Pumps</h2>
            <p className="text-4xl p-4">Water Pressure Pumps Residential | Residential Submersible Pump - Powerful Residential Water Pump</p>
