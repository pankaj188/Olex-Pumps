...
const JCPResidentialpump = () => {
    return (
        <div>
            ...
            <div className=" mx-6  ">
            <img className="md:mx-52" src={JCP}></img>
            </div>
            <div className="text-center mx-6 p-12">
            <h2 className=" p-2 md:text-6xl font-bold my-20 ">JCP Centrifugal Deep Well Jet Pumps</h2>
            <p className="md:text-4xl p-4">Water Pressure Pumps Residential | Residential Centrifugal Pumps</p>
