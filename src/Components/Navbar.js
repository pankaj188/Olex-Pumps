        ...
        <nav>
            <div className="flex justify-evenly shadow-md bg-blue-900  ">
                    <div className="flex space-x-4 md:place-items-center ">
                            ...
                            <li class="dropdown hover:text-gray-200"><a class="dropdown-toggle" data-toggle="dropdown" >Products <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                            <Link  to="/agriculture"><li className="text-gray-500 px-3">Agriculture Pumps</li></Link>
                            <Link  to="/residential"><li className="text-gray-500 px-3">Residential Pumps</li></Link>
                             </ul>
                            </li>
