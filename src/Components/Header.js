...
return(
        <div className=" flex text-center bg-gray-50 w-72 md:w-full  sm:m-2 ">
                ...
                <Link to="/products"><div className="flex items-center md:place-items-center w-[300px] mt-16 text-lg sm:text-3xl  font-bold ">Olex Pumps & Electricals LLP</div></Link>
