...
return(
        <div className=" flex text-center bg-gray-50 w-72 md:w-full  sm:m-2 ">
                <div className="logo-container ">
                <img className="w-52  max-w-md h-48" alt= "logo" src={logo}/>
                </div>
                <Link to="/products"><div className="flex items-center md:place-items-center w-[300px] mt-20 m-2 text-xl md:text-3xl  font-bold ">Olex Pumps & Electricals LLP</div></Link>
