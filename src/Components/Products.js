...
const Products = () => {
    return (
        <div className="flex flex-wrap m-2 sm:m-2 "> 
            <div className="sm:flex ">
                <div className=" mx-20 sm:mx-16 space-x-11 my-10 p-4 w-[420px] md:w-7/12 border-2 cursor-pointer shadow-md hover:bg-gray-200" ><Link to="/agriculture"><img className=""  src="https://d13bbii8ozdt01.cloudfront.net/uploads/2019/11/pump-listing-banner-agriculture-new_compressed.png"/></Link>
                ...
                <div className=" mx-20 sm:mx-24 space-x-10 my-10 w-[420px] md:w-7/12 p-4 shadow-md border-2 cursor-pointer hover:bg-gray-200"><Link to="/residential"> <img className="" src="https://d13bbii8ozdt01.cloudfront.net/uploads/2019/11/pump-listing-banner-residential-new_compressed.png"/></Link>
